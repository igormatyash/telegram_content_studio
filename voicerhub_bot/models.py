...
CONTENT_STATUS_NEEDS_CHANGES = "needs_changes"
...
CONTENT_STATUS_TRANSITIONS = {
    CONTENT_STATUS_IDEA: {CONTENT_STATUS_DRAFT},
    CONTENT_STATUS_DRAFT: {CONTENT_STATUS_REVIEW, CONTENT_STATUS_READY},
    CONTENT_STATUS_REVIEW: {
        CONTENT_STATUS_NEEDS_CHANGES,
        CONTENT_STATUS_READY,
    },
    CONTENT_STATUS_NEEDS_CHANGES: {CONTENT_STATUS_DRAFT},
    CONTENT_STATUS_READY: {CONTENT_STATUS_DRAFT, CONTENT_STATUS_SCHEDULED},
    CONTENT_STATUS_SCHEDULED: {
        CONTENT_STATUS_READY,
        CONTENT_STATUS_PUBLISHED,
    },
    CONTENT_STATUS_PUBLISHED: set(),
}
